<div id="carouselExampleIndicators" class="carousel slide"  >
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/6ae25c23-83b7-4955-918c-5d4fe1ca7c73___505822ef6dedabf8ef20860a8af4a482.jpg"
                    class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/7932a7cb-81f5-4385-8bca-b6f8d241fe2e___edef5a40bda4bf63ad6de6a031242986.jpg"
                    class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/3d7ee538-25ff-41d4-b467-1c2a64c4e33e___12778bdbd4d394eced071cbff8274a3a.jpg"
                    class="d-block w-100" alt="...">
            </div>
        </div>
...
<div class="container-fluid m-0 p-0 mt-5 row">
    <div class="col-lg-3 col-md-3 col-sm-5 p-2">
        <div class="card">
            <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/a08e607a-86ad-4eca-a7c8-a15029032d77___326976e6608822824d47d236a3ada232.jpg"
    ...
    <div class="col-lg-3 col-md-3 col-sm-5 p-2">
        <div class="card">
            <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/7f791f0c-bf4b-4d11-a4e5-712c35738923___0ec832a2b33fca5b0974e9eb22a629e7.jpg"
                class="card-img-top" alt="...">
    ...
    <div class="col-lg-3 col-md-3 col-sm-5 p-2">
        <div class="card">
            <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/9ca20068-2d03-469d-996d-f9708b3ecffb___baa266865b55a1e0e692abc815f31ae7.jpg"
                class="card-img-top" alt="...">

        </div>
        <div class="card-body">
            <p class="card-text">SKINCARE</p>
        </div>
    </div>

    <div class="col-lg-3 col-md-3 col-sm-5 p-2">
        <div class="card">
            <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/30f4226f-7dee-44ab-9422-4ea513b6925a___2ad1556739bdb0f602005e7529e50bd9.jpg"
                class="card-img-top" alt="...">

        </div>
        <div class="card-body">
            <p class="card-text">MODA Y ACCESORIO</p>
        </div>
    </div>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="row">
          <div class="col-md-3 col-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body " style="text-align: start;">
                ...
                <a href="descripciondeproducto.html" class="btn btn-primary"style="margin-left: 60px;"> Ver detalle </a>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-6 mb-4">
          ...
          <div class="col-md-3 col-6 mb-4">
            <div class="card h-100">
              <img src="https://esikaperu.vtexassets.com/arquivos/ids/259883-500-auto?v=638242310989800000&width=500&height=auto&aspect=true" class="card-img-top" alt="Producto 4">
              <div class="card-body " style="text-align: start;">
      ...
      <div class="carousel-item">
        <div class="row">
          <div class="col-md-3 col-6 mb-4">
            <div class="card h-100">
              <img src="https://esikaperu.vtexassets.com/arquivos/ids/310749-500-auto?v=638556162401630000&width=500&height=auto&aspect=true" class="card-img-top" alt="Producto 5">
              <div class="card-body " style="text-align: start;">
          ...
          <div class="col-md-3 col-6 mb-4">
            <div class="card h-100">
              <img src="https://esikaperu.vtexassets.com/arquivos/ids/311179-500-auto?v=638566512130530000&width=500&height=auto&aspect=true" class="card-img-top" alt="Producto 6">
              <div class="card-body " style="text-align: start;">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="row">
          <div class="col-md-3 col-6 mb-4">
            <div class="card h-100">
              <img src="https://esikaperu.vtexassets.com/arquivos/ids/311218-500-auto?v=638566602189600000&width=500&height=auto&aspect=true" class="card-img-top" alt="Producto 1">
              <div class="card-body " style="text-align: start;">
          ...
          <div class="col-md-3 col-6 mb-4">
            <div class="card h-100">
              <img src="https://esikaperu.vtexassets.com/arquivos/ids/308261-500-auto?v=638544150239000000&width=500&height=auto&aspect=true" class="card-img-top" alt="Producto 4">
              <div class="card-body " style="text-align: start;">
      ...
      <div class="carousel-item">
        <div class="row">
          ...
          <div class="col-md-3 col-6 mb-4">
            <div class="card h-100">
              <img src="https://esikaperu.vtexassets.com/arquivos/ids/310560-500-auto?v=638555322201800000&width=500&height=auto&aspect=true" class="card-img-top" alt="Producto 8">
              <div class="card-body " style="text-align: start;">
                <h5 class="card-title mb-2">Vibranza Addiction Perfume de Mujer, 45ml</h5>
...
<div id="imagenes_productos" class="col-6 row m-0">
    <div id="imagen_principal" class="col-12 p-2" style=" height: auto;"> 
        <img src="https://cyzoneperu.vtexassets.com/assets/vtex.file-manager-graphql/images/fe5e7f08-1f83-41a5-b49f-1a6bc6589866___e6acbbb8334c5ed38ae0243fac6a4b1d.jpg" 
        alt="" width="400" height="600">
        <button class="" style="background-color: red; border: red; color: white; "> 
            <a href=""></a>Conoce mas</button>
</div>
