        ...
        <div id="detalles" class="col-10 p-2 mt-2" style=" height:auto;background-color: rgb(243, 243, 245);">
            <div class="container-fluid m-0 p-3 mt-4 row">
                <div class="container-fluid m-0 p-3 mt-2 row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                        <div class="card ">
                        <img src="https://esikaperu.vtexassets.com/arquivos/ids/310254-500-auto?v=638549328216430000&width=500&height=auto&aspect=true" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"style="text-align: center;">Mega Full Size Máscara de Pestañas Fácil Retirado</h5>
                            <div class="star"style="margin-left: 60px;">
                                <h5 style="text-align: center;">★★★★★</h5>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                        <div class="card ">
                        <img src="https://esikaperu.vtexassets.com/arquivos/ids/306855-500-auto?v=638526984178370000&width=500&height=auto&aspect=true" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"style="text-align: center;">Mega Full Size Máscara de Pestañas Fácil Retirado</h5>
                            <div class="star"style="margin-left: 60px;">
                                <h5 style="text-align: center;">★★★★★</h5>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                        <div class="card ">
                        <img src="https://esikaperu.vtexassets.com/arquivos/ids/279272-500-auto?v=638295450929800000&width=500&height=auto&aspect=true" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"style="text-align: center;">Mega Full Size Máscara de Pestañas Fácil Retirado</h5>
                            <div class="star"style="margin-left: 60px;">
                                <h5 style="text-align: center;">★★★★★</h5>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"style="text-align: center;">MMega Full Size Máscara de Pestañas Fácil Retirado</h5>
                            <div class="star"style="margin-left: 60px;">
                                <h5 style="text-align: center;">★★★★★</h5>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                        <div class="card ">
                        <img src="https://esikaperu.vtexassets.com/arquivos/ids/272250-500-auto?v=638242824041030000&width=500&height=auto&aspect=true" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"style="text-align: center;">Mega Full Size Máscara de Pestañas Fácil Retirado</h5>
                            <div class="star"style="margin-left: 60px;">
                                <h5 style="text-align: center;">★★★★★</h5>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                        <div class="card ">
                        <img src="https://esikaperu.vtexassets.com/arquivos/ids/279509-500-auto?v=638295455975630000&width=500&height=auto&aspect=true" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"style="text-align: center;">Mega Full Size Máscara de Pestañas Fácil Retirado</h5>
                            <div class="star"style="margin-left: 60px;">
                                <h5 style="text-align: center;">★★★★★</h5>
