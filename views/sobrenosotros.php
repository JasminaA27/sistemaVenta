...
<body>
    <div class="container">
        ...
        <div class="content" style="background-color: rgb(231, 236, 236);">
            ...
            <div class="row section my-4">
                <div class="col-md-6 order-md-2">
                    <h2>Las personas nos importan</h2>
        ...
        <div class="faq my-4 text-center " style="background-color: rgb(231, 236, 236);">
            <h2 style="color: red;">Nuestras respuestas a tus preguntas</h2>
            <div class="faq-section my-3 text-center">
                <h3>Mi cuenta</h3>
                <p>¿Cómo cambio mi usuario/contraseña?</p>
                <p>¿Cómo puedo crear mi cuenta?</p>
            </div>
            <div class="faq-section my-3 text-center">
                <h3>Producto</h3>
                <p>¿Qué métodos de pago puedo usar para pagar mi pedido?</p>
                <p>¿Qué pasa si el pedido no llega dentro del tiempo solicitado?</p>
            </div>
        </div>
    </div>
